...
impl BodyrequestOrdersActionsStopLimitTv {
  pub fn new(comment: String, end_time: DateTime<Utc>, instrument: BodyrequestOrdersActionsLimitTvInstrument, price: Decimal, quantity: i32, side: Side, stop_end_unix_time: i64, symbol: String, take_profit: Decimal, trigger_price: Decimal, rtype: String, user: BodyrequestOrdersActionsMarketTVputUser, ) -> BodyrequestOrdersActionsStopLimitTv {
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsStopLimitTv {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsStopLimitTv {
    self.side = side;
    self
  }
