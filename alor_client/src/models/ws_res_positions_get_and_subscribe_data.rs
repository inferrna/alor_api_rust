...
impl WsResPositionsGetAndSubscribeData {
  pub fn new(avg_price: Decimal, broker_symbol: String, daily_unrealised_pl: Decimal, exchange: Exchange, is_currency: bool, lot_size: i32, open: i32, open_qty_batch: i32, open_units: i32, qty: i32, qty_batch: i32, qty_t0: i32, qty_t0_batch: i32, qty_t1: i32, qty_t1_batch: i32, qty_t2: i32, qty_t2_batch: i32, qty_t_future: i32, qty_t_future_batch: i32, qty_units: i32, short_name: String, symbol: String, unrealised_pl: Decimal, ) -> WsResPositionsGetAndSubscribeData {
