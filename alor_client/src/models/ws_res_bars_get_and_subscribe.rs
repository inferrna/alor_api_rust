...
impl WsResBarsGetAndSubscribe {
  pub fn new(data: HistoryObject, guid: String, ) -> WsResBarsGetAndSubscribe {
  ...
  pub fn set_data(&mut self, data: HistoryObject) {
    self.data = data;
  }

  pub fn with_data(mut self, data: HistoryObject) -> WsResBarsGetAndSubscribe {
    self.data = data;
    self
  }
  
  pub fn data(&self) -> &HistoryObject {
    &self.data
  }
