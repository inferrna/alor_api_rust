...
impl WsResBarsGetAndSubscribe {
  pub fn new(data: WsResBarsGetAndSubscribeData, guid: String, ) -> WsResBarsGetAndSubscribe {
  ...
  pub fn set_data(&mut self, data: WsResBarsGetAndSubscribeData) {
    self.data = data;
  }

  pub fn with_data(mut self, data: WsResBarsGetAndSubscribeData) -> WsResBarsGetAndSubscribe {
    self.data = data;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsResBarsGetAndSubscribe {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений подписки. Значение во входящем сообщении равно значению одноимённого поля, переданному при установке соединения.
