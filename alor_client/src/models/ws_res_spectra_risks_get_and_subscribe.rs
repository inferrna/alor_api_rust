...
pub struct WsResSpectraRisksGetAndSubscribe {
  #[serde(rename = "data")]
...
impl WsResSpectraRisksGetAndSubscribe {
  pub fn new(data: Fortsrisk, guid: String, ) -> WsResSpectraRisksGetAndSubscribe {
  ...
  pub fn set_data(&mut self, data: Fortsrisk) {
    self.data = data;
  }

  pub fn with_data(mut self, data: Fortsrisk) -> WsResSpectraRisksGetAndSubscribe {
    self.data = data;
    self
  }
  
  pub fn data(&self) -> &Fortsrisk {
    &self.data
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsResSpectraRisksGetAndSubscribe {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений подписки. Значение во входящем сообщении равно значению одноимённого поля, переданному при установке соединения.
