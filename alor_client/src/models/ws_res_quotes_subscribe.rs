...
impl WsResQuotesSubscribe {
  pub fn new(data: WsResQuotesSubscribeData, guid: String, ) -> WsResQuotesSubscribe {
  ...
  pub fn set_data(&mut self, data: WsResQuotesSubscribeData) {
    self.data = data;
  }

  pub fn with_data(mut self, data: WsResQuotesSubscribeData) -> WsResQuotesSubscribe {
    self.data = data;
    self
  }
  
  pub fn data(&self) -> &WsResQuotesSubscribeData {
    &self.data
  }
