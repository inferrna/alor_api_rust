...
impl Money {
  pub fn new(cash: Decimal, changes: Decimal, comission: Decimal, free: Decimal, open: Decimal, portfolio: String, profit: Decimal, profit_rate: Decimal, used: Decimal, ) -> Money {
    Money {
      cash: cash,
      changes: changes,
      comission: comission,
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> Money {
    self.portfolio = portfolio;
    self
  }
  ///Идентификатор клиентского портфеля
