...
pub struct WsResSummariesGetAndSubscribeV2 {
  #[serde(rename = "data")]
  
  data: WsResSummariesGetAndSubscribeV2Data, 
  #[serde(rename = "guid")]
...
impl WsResSummariesGetAndSubscribeV2 {
  pub fn new(data: WsResSummariesGetAndSubscribeV2Data, guid: String, ) -> WsResSummariesGetAndSubscribeV2 {
  ...
  pub fn set_data(&mut self, data: WsResSummariesGetAndSubscribeV2Data) {
    self.data = data;
  }

  pub fn with_data(mut self, data: WsResSummariesGetAndSubscribeV2Data) -> WsResSummariesGetAndSubscribeV2 {
    self.data = data;
    self
  }
  
  pub fn data(&self) -> &WsResSummariesGetAndSubscribeV2Data {
    &self.data
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsResSummariesGetAndSubscribeV2 {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений подписки. Значение во входящем сообщении равно значению одноимённого поля, переданному при установке соединения.
