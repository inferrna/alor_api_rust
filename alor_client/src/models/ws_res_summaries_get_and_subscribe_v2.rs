...
impl WsResSummariesGetAndSubscribeV2 {
  pub fn new(data: Summary, guid: String, ) -> WsResSummariesGetAndSubscribeV2 {
  ...
  pub fn set_data(&mut self, data: Summary) {
    self.data = data;
  }

  pub fn with_data(mut self, data: Summary) -> WsResSummariesGetAndSubscribeV2 {
    self.data = data;
    self
  }
  
  pub fn data(&self) -> &Summary {
    &self.data
  }
