...
pub struct WsReqInstrumentsGetAndSubscribeV2 {
  #[serde(rename = "code")]
  ///Тикер
  code: String,  // SBER 
...
impl WsReqInstrumentsGetAndSubscribeV2 {
  pub fn new(code: String, exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, token: String, ) -> WsReqInstrumentsGetAndSubscribeV2 {
  ...
  pub fn with_code(mut self, code: String) -> WsReqInstrumentsGetAndSubscribeV2 {
    self.code = code;
    self
  }
  ///Тикер
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqInstrumentsGetAndSubscribeV2 {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqInstrumentsGetAndSubscribeV2 {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqInstrumentsGetAndSubscribeV2 {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений создаваемой подписки. Все входящие сообщения, соответствующие этой подписке, будут иметь такое значение поля guid.
  ...
  pub fn with_opcode(mut self, opcode: OpcodeEnum) -> WsReqInstrumentsGetAndSubscribeV2 {
    self.opcode = opcode;
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> WsReqInstrumentsGetAndSubscribeV2 {
    self.token = token;
    self
  }
  ///JWT токен для авторизации
