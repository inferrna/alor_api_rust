...
pub struct BodyrequestOrdersActionsLimitTvUser {
  #[serde(rename = "portfolio")]
  portfolio: String  // D39004 
}

impl BodyrequestOrdersActionsLimitTvUser {
  pub fn new(portfolio: String, ) -> BodyrequestOrdersActionsLimitTvUser {
    BodyrequestOrdersActionsLimitTvUser {
      portfolio: portfolio
    }
  }
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> BodyrequestOrdersActionsLimitTvUser {
    self.portfolio = portfolio;
    self
  }
