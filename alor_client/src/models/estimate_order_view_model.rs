...
impl EstimateOrderViewModel {
  ...
  pub fn with_board(mut self, board: String) -> EstimateOrderViewModel {
    self.board = Some(board);
    self
  }
  ///Код режима торгов (Борд)
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> EstimateOrderViewModel {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_lot_quantity(mut self, lot_quantity: i64) -> EstimateOrderViewModel {
    self.lot_quantity = lot_quantity;
    self
  }
  ///Количество лотов
  ...
  pub fn with_price(mut self, price: Decimal) -> EstimateOrderViewModel {
    self.price = price;
    self
  }
  ///Цена
