...
impl StoporderWarp {
  ...
  pub fn with_condition(mut self, condition: String) -> StoporderWarp {
    self.condition = condition;
    self
  }
  ...
  pub fn set_exchange_order_id(&mut self, exchange_order_id: Decimal) {
    self.exchange_order_id = exchange_order_id;
  }

  pub fn with_exchange_order_id(mut self, exchange_order_id: Decimal) -> StoporderWarp {
    self.exchange_order_id = exchange_order_id;
    self
  }
  ...
  pub fn with_side(mut self, side: Operation) -> StoporderWarp {
    self.side = side;
    self
  }
