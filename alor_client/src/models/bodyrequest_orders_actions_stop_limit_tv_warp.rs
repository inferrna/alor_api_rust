...
impl BodyrequestOrdersActionsStopLimitTvWarp {
  ...
  pub fn with_condition(mut self, condition: String) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.condition = condition;
    self
  }
  ...
  pub fn with_iceberg_fixed(mut self, iceberg_fixed: Decimal) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.iceberg_fixed = iceberg_fixed;
    self
  }
  ...
  pub fn with_side(mut self, side: Operation) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.side = side;
    self
  }
