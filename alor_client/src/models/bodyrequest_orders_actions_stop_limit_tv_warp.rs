...
impl BodyrequestOrdersActionsStopLimitTvWarp {
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
  ...
  pub fn with_condition(mut self, condition: Condition) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.condition = condition;
    self
  }
  ...
  pub fn with_iceberg_fixed(mut self, iceberg_fixed: i32) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.iceberg_fixed = iceberg_fixed;
    self
  }
  ///Видимая постоянная часть айсберг-заявки в лотах
  ...
  pub fn with_iceberg_variance(mut self, iceberg_variance: Decimal) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.iceberg_variance = iceberg_variance;
    self
  }
  ///Амплитуда отклонения (в % от icebergFixed) случайной надбавки к видимой части айсберг-заявки. Только срочный рынок
  ...
  pub fn set_instrument(&mut self, instrument: BodyrequestOrdersActionsStopLimitTvWarpInstrument) {
    self.instrument = instrument;
  }

  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsStopLimitTvWarpInstrument) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_price(mut self, price: Decimal) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.price = price;
    self
  }
  ///Цена выставления стоп-лимитной заявки
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.quantity = quantity;
    self
  }
  ///Количество (лоты)
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.side = side;
    self
  }
  ...
  pub fn with_time_in_force(mut self, time_in_force: LifePolicy) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.time_in_force = time_in_force;
    self
  }
  ...
  pub fn with_trigger_price(mut self, trigger_price: Decimal) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.trigger_price = trigger_price;
    self
  }
  ///Стоп-цена
  ...
  pub fn set_user(&mut self, user: BodyrequestOrdersActionsStopLimitTvWarpUser) {
    self.user = user;
  }

  pub fn with_user(mut self, user: BodyrequestOrdersActionsStopLimitTvWarpUser) -> BodyrequestOrdersActionsStopLimitTvWarp {
    self.user = user;
    self
  }
  ...
  pub fn validate(&self) {
    ...
    assert!(self.iceberg_variance<=max_value, "BodyrequestOrdersActionsStopLimitTvWarp.iceberg_variance should be <= 20");
  }
