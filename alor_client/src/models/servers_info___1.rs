...
impl ServersInfo1 {
  pub fn new(portfolio: String, tks: String, trade_servers_info: Vec<ServersInfoTradeServersInfo1>, ) -> ServersInfo1 {
    ServersInfo1 {
      portfolio: portfolio,
      tks: tks,
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> ServersInfo1 {
    self.portfolio = portfolio;
    self
  }
  ///Идентификатор клиентского портфеля
  ...
  pub fn with_tks(mut self, tks: String) -> ServersInfo1 {
    self.tks = tks;
    self
  }
  ...
  pub fn set_trade_servers_info(&mut self, trade_servers_info: Vec<ServersInfoTradeServersInfo1>) {
    self.trade_servers_info = trade_servers_info;
  }

  pub fn with_trade_servers_info(mut self, trade_servers_info: Vec<ServersInfoTradeServersInfo1>) -> ServersInfo1 {
    self.trade_servers_info = trade_servers_info;
    self
  }
