...
pub enum LifePolicy {
  #[serde(rename(serialize = "OneDay"))]
  #[serde(alias = "OneDay")]
  ONE_DAY,
  #[serde(rename(serialize = "ImmediateOrCancel"))]
  #[serde(alias = "ImmediateOrCancel")]
  IMMEDIATE_OR_CANCEL,
  #[serde(rename(serialize = "FillOrKill"))]
  #[serde(alias = "FillOrKill")]
  FILL_OR_KILL,
  #[serde(rename(serialize = "AtTheClose"))]
  #[serde(alias = "AtTheClose")]
  AT_THE_CLOSE,
  #[serde(rename(serialize = "GoodTillCancelled"))]
  #[serde(alias = "GoodTillCancelled")]
  GOOD_TILL_CANCELLED,
}
/*
impl ToString for LifePolicy {
  fn to_string(&self) -> String {
      serde_json::to_value(self).unwrap().as_str().unwrap().to_string()
  }
}
*/
impl std::fmt::Display for LifePolicy {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        let formatted = serde_json::to_value(self).unwrap().as_str().unwrap().to_string();
        write!(f, "{:?}", formatted)
    }
}
impl<'a> OutlinePrint<'a> for LifePolicy {
