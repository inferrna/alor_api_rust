...
pub struct WsReqRisksGetAndSubscribe {
  ...
  #[serde(rename = "opcode")]
  opcode: String,  // RisksGetAndSubscribe 
...
impl WsReqRisksGetAndSubscribe {
  pub fn new(exchange: Exchange, format: JsonFormat, guid: String, opcode: String, portfolio: String, token: String, ) -> WsReqRisksGetAndSubscribe {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqRisksGetAndSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqRisksGetAndSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqRisksGetAndSubscribe {
    self.guid = guid;
    self
  }
  ...
  pub fn with_opcode(mut self, opcode: String) -> WsReqRisksGetAndSubscribe {
    self.opcode = opcode;
    self
  }
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> WsReqRisksGetAndSubscribe {
    self.portfolio = portfolio;
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> WsReqRisksGetAndSubscribe {
    self.token = token;
    self
  }
