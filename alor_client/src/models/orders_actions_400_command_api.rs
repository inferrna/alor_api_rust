...
impl OrdersActions400CommandApi {
  pub fn new(message: String, old_response: OrdersActions400CommandApiOldResponse, ) -> OrdersActions400CommandApi {
  ...
  pub fn with_message(mut self, message: String) -> OrdersActions400CommandApi {
    self.message = message;
    self
  }
  ///Вид ответа для неуникального X-ALOR-REQID
  ...
  pub fn set_old_response(&mut self, old_response: OrdersActions400CommandApiOldResponse) {
    self.old_response = old_response;
  }

  pub fn with_old_response(mut self, old_response: OrdersActions400CommandApiOldResponse) -> OrdersActions400CommandApi {
    self.old_response = old_response;
    self
  }
