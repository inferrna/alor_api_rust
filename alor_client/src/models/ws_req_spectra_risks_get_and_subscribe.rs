...
pub struct WsReqSpectraRisksGetAndSubscribe {
  ...
  portfolio: String,  // 7500PUQ 
  #[serde(rename = "token")]
  token: String  // eyJhbGciOiJ... 
}

impl WsReqSpectraRisksGetAndSubscribe {
  pub fn new(exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, portfolio: String, token: String, ) -> WsReqSpectraRisksGetAndSubscribe {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqSpectraRisksGetAndSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqSpectraRisksGetAndSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqSpectraRisksGetAndSubscribe {
    self.guid = guid;
    self
  }
  ...
  pub fn with_opcode(mut self, opcode: OpcodeEnum) -> WsReqSpectraRisksGetAndSubscribe {
    self.opcode = opcode;
    self
  }
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> WsReqSpectraRisksGetAndSubscribe {
    self.portfolio = portfolio;
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> WsReqSpectraRisksGetAndSubscribe {
    self.token = token;
    self
  }
