...
pub struct WsResRisksGetAndSubscribe {
  #[serde(rename = "data")]
...
impl WsResRisksGetAndSubscribe {
  pub fn new(data: Risk, guid: String, ) -> WsResRisksGetAndSubscribe {
  ...
  pub fn set_data(&mut self, data: Risk) {
    self.data = data;
  }

  pub fn with_data(mut self, data: Risk) -> WsResRisksGetAndSubscribe {
    self.data = data;
    self
  }
  
  pub fn data(&self) -> &Risk {
    &self.data
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsResRisksGetAndSubscribe {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений подписки. Значение во входящем сообщении равно значению одноимённого поля, переданному при установке соединения.
