...
impl OrderbookAsk {
  pub fn new(price: Decimal, volume: i64, ) -> OrderbookAsk {
    OrderbookAsk {
      price: price,
      volume: volume
    }
  ...
  pub fn with_price(mut self, price: Decimal) -> OrderbookAsk {
    self.price = price;
    self
  }
  ///Цена
  ...
  pub fn with_volume(mut self, volume: i64) -> OrderbookAsk {
    self.volume = volume;
    self
  }
  ///Объём
