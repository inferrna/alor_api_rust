...
impl WsResHandledSuccessfully {
  pub fn new(http_code: i32, message: String, request_guid: String, ) -> WsResHandledSuccessfully {
  ...
  pub fn set_http_code(&mut self, http_code: i32) {
    self.http_code = http_code;
  }

  pub fn with_http_code(mut self, http_code: i32) -> WsResHandledSuccessfully {
    self.http_code = http_code;
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> WsResHandledSuccessfully {
    self.message = message;
    self
  }
  ...
  pub fn set_request_guid(&mut self, request_guid: String) {
    self.request_guid = request_guid;
  }

  pub fn with_request_guid(mut self, request_guid: String) -> WsResHandledSuccessfully {
    self.request_guid = request_guid;
    self
  }
