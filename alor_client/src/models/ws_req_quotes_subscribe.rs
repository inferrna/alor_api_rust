...
impl WsReqQuotesSubscribe {
  pub fn new(code: String, exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, token: String, ) -> WsReqQuotesSubscribe {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqQuotesSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqQuotesSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqQuotesSubscribe {
    self.guid = guid;
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> WsReqQuotesSubscribe {
    self.token = token;
    self
  }
