...
impl Stoporder {
  pub fn new(broker_symbol: String, end_time: DateTime<Utc>, exchange: Exchange, existing: bool, filled_qty_batch: Decimal, id: Decimal, price: Decimal, qty: Decimal, side: Side, status: OrderStatus, stop_price: Decimal, symbol: String, rtype: StopOrderType, ) -> Stoporder {
    Stoporder {
  ...
  pub fn with_side(mut self, side: Side) -> Stoporder {
    self.side = side;
    self
  }
