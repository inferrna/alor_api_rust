...
impl BodyrequestOrdersActionsStop {
  pub fn new(instrument: BodyrequestOrdersActionsStopInstrument, order_end_unix_time: i64, quantity: i32, side: Side, trigger_price: Decimal, user: BodyrequestOrdersActionsStopUser, comment: String, ) -> BodyrequestOrdersActionsStop {
  ...
  pub fn set_instrument(&mut self, instrument: BodyrequestOrdersActionsStopInstrument) {
    self.instrument = instrument;
  }

  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsStopInstrument) -> BodyrequestOrdersActionsStop {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_order_end_unix_time(mut self, order_end_unix_time: i64) -> BodyrequestOrdersActionsStop {
    self.order_end_unix_time = order_end_unix_time;
    self
  }
  ///Время (UTC) завершения сделки в формате Unix Time Seconds
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsStop {
    self.quantity = quantity;
    self
  }
  ///Количество
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsStop {
    self.side = side;
    self
  }
  ...
  pub fn with_trigger_price(mut self, trigger_price: Decimal) -> BodyrequestOrdersActionsStop {
    self.trigger_price = trigger_price;
    self
  }
  ///Стоп-цена
  ...
  pub fn set_user(&mut self, user: BodyrequestOrdersActionsStopUser) {
    self.user = user;
  }

  pub fn with_user(mut self, user: BodyrequestOrdersActionsStopUser) -> BodyrequestOrdersActionsStop {
    self.user = user;
    self
  }
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsStop {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
