...
impl WsResPositionsGetAndSubscribe {
  pub fn new(data: Position, guid: String, ) -> WsResPositionsGetAndSubscribe {
  ...
  pub fn set_data(&mut self, data: Position) {
    self.data = data;
  }

  pub fn with_data(mut self, data: Position) -> WsResPositionsGetAndSubscribe {
    self.data = data;
    self
  }
