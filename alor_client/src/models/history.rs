...
impl History {
  pub fn new(history: Vec<HistoryObject>, ) -> History {
    History {
      history: history,
      next: None,
      prev: None
  ...
  pub fn set_history(&mut self, history: Vec<HistoryObject>) {
    self.history = history;
  }

  pub fn with_history(mut self, history: Vec<HistoryObject>) -> History {
    self.history = history;
    self
  }
