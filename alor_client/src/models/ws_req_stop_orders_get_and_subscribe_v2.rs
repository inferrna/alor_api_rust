...
pub struct WsReqStopOrdersGetAndSubscribeV2 {
...
impl WsReqStopOrdersGetAndSubscribeV2 {
  pub fn new(exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, portfolio: String, token: String, ) -> WsReqStopOrdersGetAndSubscribeV2 {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqStopOrdersGetAndSubscribeV2 {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqStopOrdersGetAndSubscribeV2 {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqStopOrdersGetAndSubscribeV2 {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений создаваемой подписки. Все входящие сообщения, соответствующие этой подписке, будут иметь такое значение поля guid.
  ...
  pub fn with_opcode(mut self, opcode: OpcodeEnum) -> WsReqStopOrdersGetAndSubscribeV2 {
    self.opcode = opcode;
    self
  }
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> WsReqStopOrdersGetAndSubscribeV2 {
    self.portfolio = portfolio;
    self
  }
  ///Идентификатор клиентского портфеля
  ...
  pub fn with_token(mut self, token: String) -> WsReqStopOrdersGetAndSubscribeV2 {
    self.token = token;
    self
  }
  ///JWT токен для авторизации
