...
impl BodyrequestOrdersActionsStopMarketTvWarp {
  pub fn new(activate: bool, comment: String, condition: Condition, instrument: BodyrequestOrdersActionsStopLimitTvWarpInstrument, quantity: i32, side: Side, stop_end_unix_time: i64, trigger_price: Decimal, user: BodyrequestOrdersActionsStopLimitTvWarpUser, ) -> BodyrequestOrdersActionsStopMarketTvWarp {
  ...
  pub fn with_activate(mut self, activate: bool) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.activate = activate;
    self
  }
  ///Флаг указывает, создать активную заявку, или не активную. Не активная заявка отображается в системе, но не участвует в процессе выставления на биржу, пока не станет активной. Данный флаг необходим при создании группы заявок с типом 'TriggerBracketOrders' 
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
  ...
  pub fn with_condition(mut self, condition: Condition) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.condition = condition;
    self
  }
  ...
  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsStopLimitTvWarpInstrument) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.quantity = quantity;
    self
  }
  ///Количество (лоты)
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.side = side;
    self
  }
  ...
  pub fn with_trigger_price(mut self, trigger_price: Decimal) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.trigger_price = trigger_price;
    self
  }
  ///Стоп-цена
  ...
  pub fn with_user(mut self, user: BodyrequestOrdersActionsStopLimitTvWarpUser) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.user = user;
    self
  }
