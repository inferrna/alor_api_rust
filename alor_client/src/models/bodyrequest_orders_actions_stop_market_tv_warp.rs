...
impl BodyrequestOrdersActionsStopMarketTvWarp {
  ...
  pub fn with_condition(mut self, condition: String) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.condition = condition;
    self
  }
  ///Условие срабатывания more/less
  ...
  pub fn with_side(mut self, side: Operation) -> BodyrequestOrdersActionsStopMarketTvWarp {
    self.side = side;
    self
  }
