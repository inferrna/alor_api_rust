...
pub struct WsReqPositionsGetAndSubscribe {
...
impl WsReqPositionsGetAndSubscribe {
  pub fn new(exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, portfolio: String, token: String, ) -> WsReqPositionsGetAndSubscribe {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqPositionsGetAndSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqPositionsGetAndSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqPositionsGetAndSubscribe {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений создаваемой подписки. Все входящие сообщения, соответствующие этой подписке, будут иметь такое значение поля guid.
  ...
  pub fn with_opcode(mut self, opcode: OpcodeEnum) -> WsReqPositionsGetAndSubscribe {
    self.opcode = opcode;
    self
  }
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> WsReqPositionsGetAndSubscribe {
    self.portfolio = portfolio;
    self
  }
  ///Идентификатор клиентского портфеля
  ...
  pub fn with_token(mut self, token: String) -> WsReqPositionsGetAndSubscribe {
    self.token = token;
    self
  }
  ///JWT токен для авторизации
