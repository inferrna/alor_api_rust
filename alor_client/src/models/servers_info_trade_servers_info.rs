...
pub struct ServersInfoTradeServersInfo {
...
impl ServersInfoTradeServersInfo {
  pub fn new(contracts: String, trade_server_code: String, ) -> ServersInfoTradeServersInfo {
    ServersInfoTradeServersInfo {
      account_num: None,
      addresses: None,
      contracts: contracts,
      market: None,
  ...
  pub fn with_account_num(mut self, account_num: String) -> ServersInfoTradeServersInfo {
    self.account_num = Some(account_num);
    self
  }
  ...
  pub fn with_addresses(mut self, addresses: String) -> ServersInfoTradeServersInfo {
    self.addresses = Some(addresses);
    self
  }
  ...
  pub fn with_contracts(mut self, contracts: String) -> ServersInfoTradeServersInfo {
    self.contracts = contracts;
    self
  }
  ...
  pub fn with_market(mut self, market: String) -> ServersInfoTradeServersInfo {
    self.market = Some(market);
    self
  }
  ...
  pub fn with_trade_server_code(mut self, trade_server_code: String) -> ServersInfoTradeServersInfo {
    self.trade_server_code = trade_server_code;
    self
  }
  ///Код сервера
  ...
  pub fn with_rtype(mut self, rtype: String) -> ServersInfoTradeServersInfo {
    self.rtype = Some(rtype);
    self
  }
