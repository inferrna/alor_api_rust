...
pub struct WsResTradesGetAndSubscribe {
  #[serde(rename = "data")]
  data: Trade, 
  #[serde(rename = "guid")]
...
impl WsResTradesGetAndSubscribe {
  pub fn new(data: Trade, guid: String, ) -> WsResTradesGetAndSubscribe {
  ...
  pub fn set_data(&mut self, data: Trade) {
    self.data = data;
  }

  pub fn with_data(mut self, data: Trade) -> WsResTradesGetAndSubscribe {
    self.data = data;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsResTradesGetAndSubscribe {
    self.guid = guid;
    self
  }
