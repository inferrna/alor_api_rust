...
impl OrdersActionsLimitMarketCommandApi {
  pub fn new(message: String, order_number: String, ) -> OrdersActionsLimitMarketCommandApi {
  ...
  pub fn with_message(mut self, message: String) -> OrdersActionsLimitMarketCommandApi {
    self.message = message;
    self
  }
  ///Вид ответа на успешно выполненный запрос
  ...
  pub fn set_order_number(&mut self, order_number: String) {
    self.order_number = order_number;
  }

  pub fn with_order_number(mut self, order_number: String) -> OrdersActionsLimitMarketCommandApi {
    self.order_number = order_number;
    self
  }
  ///Идентификатор заявки
