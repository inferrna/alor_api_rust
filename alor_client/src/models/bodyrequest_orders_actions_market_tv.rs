...
impl BodyrequestOrdersActionsMarketTv {
  pub fn new(comment: String, instrument: BodyrequestOrdersActionsLimitTvInstrument, quantity: i32, side: Side, rtype: String, user: BodyrequestOrdersActionsLimitTvUser, ) -> BodyrequestOrdersActionsMarketTv {
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsMarketTv {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
  ...
  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsLimitTvInstrument) -> BodyrequestOrdersActionsMarketTv {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsMarketTv {
    self.quantity = quantity;
    self
  }
  ///Количество (лоты)
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsMarketTv {
    self.side = side;
    self
  }
  ...
  pub fn with_rtype(mut self, rtype: String) -> BodyrequestOrdersActionsMarketTv {
    self.rtype = rtype;
    self
  }
  ///Тип заявки
  ...
  pub fn with_user(mut self, user: BodyrequestOrdersActionsLimitTvUser) -> BodyrequestOrdersActionsMarketTv {
    self.user = user;
    self
  }
