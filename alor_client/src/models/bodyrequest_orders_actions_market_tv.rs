...
impl BodyrequestOrdersActionsMarketTv {
  pub fn new(instrument: BodyrequestOrdersActionsLimitTvInstrument, quantity: i32, side: Operation, rtype: String, user: BodyrequestOrdersActionsLimitTvUser, ) -> BodyrequestOrdersActionsMarketTv {
  ...
  pub fn with_side(mut self, side: Operation) -> BodyrequestOrdersActionsMarketTv {
    self.side = side;
    self
  }
