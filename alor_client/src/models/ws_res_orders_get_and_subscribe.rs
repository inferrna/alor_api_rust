...
pub struct WsResOrdersGetAndSubscribe {
  #[serde(rename = "data")]
...
impl WsResOrdersGetAndSubscribe {
  pub fn new(data: Order, guid: String, ) -> WsResOrdersGetAndSubscribe {
  ...
  pub fn set_data(&mut self, data: Order) {
    self.data = data;
  }

  pub fn with_data(mut self, data: Order) -> WsResOrdersGetAndSubscribe {
    self.data = data;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsResOrdersGetAndSubscribe {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений подписки. Значение во входящем сообщении равно значению одноимённого поля, переданному при установке соединения.
