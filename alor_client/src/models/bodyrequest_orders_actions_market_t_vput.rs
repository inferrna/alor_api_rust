...
impl BodyrequestOrdersActionsMarketTVput {
  pub fn new(id: i64, instrument: BodyrequestOrdersActionsLimitTvInstrument, quantity: i32, side: Side, rtype: String, user: BodyrequestOrdersActionsMarketTVputUser, ) -> BodyrequestOrdersActionsMarketTVput {
