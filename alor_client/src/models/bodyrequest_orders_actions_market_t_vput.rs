...
impl BodyrequestOrdersActionsMarketTVput {
  pub fn new(comment: String, instrument: BodyrequestOrdersActionsLimitTvInstrument, quantity: i32, side: Side, rtype: String, user: BodyrequestOrdersActionsMarketTVputUser, ) -> BodyrequestOrdersActionsMarketTVput {
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsMarketTVput {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
  ...
  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsLimitTvInstrument) -> BodyrequestOrdersActionsMarketTVput {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsMarketTVput {
    self.quantity = quantity;
    self
  }
  ///Количество
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsMarketTVput {
    self.side = side;
    self
  }
  ...
  pub fn with_rtype(mut self, rtype: String) -> BodyrequestOrdersActionsMarketTVput {
    self.rtype = rtype;
    self
  }
  ///Тип заявки
  ...
  pub fn with_user(mut self, user: BodyrequestOrdersActionsMarketTVputUser) -> BodyrequestOrdersActionsMarketTVput {
    self.user = user;
    self
  }
