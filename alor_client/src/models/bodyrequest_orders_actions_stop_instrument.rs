...
/// BodyrequestOrdersActionsStopInstrument : Информация об инструмента и бирже
...
impl BodyrequestOrdersActionsStopInstrument {
  pub fn new(exchange: Exchange, symbol: String, ) -> BodyrequestOrdersActionsStopInstrument {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> BodyrequestOrdersActionsStopInstrument {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_symbol(mut self, symbol: String) -> BodyrequestOrdersActionsStopInstrument {
    self.symbol = symbol;
    self
  }
  ///Тикер (Код финансового инструмента)
