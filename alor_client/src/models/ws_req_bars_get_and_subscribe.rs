...
impl WsReqBarsGetAndSubscribe {
  ...
  pub fn set_delayed(&mut self, delayed: String) {
    self.delayed = delayed;
  }

  pub fn with_delayed(mut self, delayed: String) -> WsReqBarsGetAndSubscribe {
    self.delayed = delayed;
    self
  }
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqBarsGetAndSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqBarsGetAndSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqBarsGetAndSubscribe {
    self.guid = guid;
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> WsReqBarsGetAndSubscribe {
    self.token = token;
    self
  }
