...
impl WsReqAllTradesGetAndSubscribe {
  pub fn new(code: String, depth: Decimal, exchange: Exchange, format: JsonFormat, guid: String, include_virtual_trades: bool, opcode: OpcodeEnum, token: String, ) -> WsReqAllTradesGetAndSubscribe {
  ...
  pub fn set_depth(&mut self, depth: Decimal) {
    self.depth = depth;
  }

  pub fn with_depth(mut self, depth: Decimal) -> WsReqAllTradesGetAndSubscribe {
    self.depth = depth;
    self
  }
  ///Если указать, то перед актуальными данными придут данные о последних N сделках. Максимум 5000.
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqAllTradesGetAndSubscribe {
    self.format = format;
    self
  }
