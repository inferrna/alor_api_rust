...
pub struct SymbolFutures {
  ...
  symbol: String,  // SBRF-9.20 
  #[serde(rename = "type")]
  
  rtype: String,  // Фьючерсный контракт SBRF-9.20 
  #[serde(rename = "volume")]
  ///Объём
...
impl SymbolFutures {
  pub fn new(ask: Decimal, bid: Decimal, description: String, exchange: Exchange, facevalue: Decimal, high_price: Decimal, last_price: Decimal, last_price_timestamp: i64, lotsize: Decimal, lotvalue: Decimal, low_price: Decimal, open_price: Decimal, prev_close_price: Decimal, symbol: String, rtype: String, volume: Decimal, ) -> SymbolFutures {
    SymbolFutures {
      accrued_int: None,
  ...
  pub fn with_accrued_int(mut self, accrued_int: Decimal) -> SymbolFutures {
    self.accrued_int = Some(accrued_int);
    self
  }
  ///Начислено
  ...
  pub fn with_accrued_interest(mut self, accrued_interest: Decimal) -> SymbolFutures {
    self.accrued_interest = Some(accrued_interest);
    self
  }
  ///Начислено
  ...
  pub fn with_ask(mut self, ask: Decimal) -> SymbolFutures {
    self.ask = ask;
    self
  }
  ///Аск
  ...
  pub fn with_bid(mut self, bid: Decimal) -> SymbolFutures {
    self.bid = bid;
    self
  }
  ///Бид
  ...
  pub fn with_change(mut self, change: Decimal) -> SymbolFutures {
    self.change = Some(change);
    self
  }
  ///Разность цены и цены предыдущего закрытия
  ...
  pub fn with_change_percent(mut self, change_percent: Decimal) -> SymbolFutures {
    self.change_percent = Some(change_percent);
    self
  }
  ///Относительное изменение цены
  ...
  pub fn with_description(mut self, description: String) -> SymbolFutures {
    self.description = description;
    self
  }
  ///Короткое описание на русском языке
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> SymbolFutures {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_facevalue(mut self, facevalue: Decimal) -> SymbolFutures {
    self.facevalue = facevalue;
    self
  }
  ...
  pub fn with_high_price(mut self, high_price: Decimal) -> SymbolFutures {
    self.high_price = high_price;
    self
  }
  ///Максимальная цена
  ...
  pub fn with_last_price(mut self, last_price: Decimal) -> SymbolFutures {
    self.last_price = last_price;
    self
  }
  ///Последняя цена
  ...
  pub fn with_lotsize(mut self, lotsize: Decimal) -> SymbolFutures {
    self.lotsize = lotsize;
    self
  }
  ///Размер лота
  ...
  pub fn with_lotvalue(mut self, lotvalue: Decimal) -> SymbolFutures {
    self.lotvalue = lotvalue;
    self
  }
  ...
  pub fn with_low_price(mut self, low_price: Decimal) -> SymbolFutures {
    self.low_price = low_price;
    self
  }
  ///Минимальная цена
  ...
  pub fn with_open_price(mut self, open_price: Decimal) -> SymbolFutures {
    self.open_price = open_price;
    self
  }
  ///Цена открытия
  ...
  pub fn with_prev_close_price(mut self, prev_close_price: Decimal) -> SymbolFutures {
    self.prev_close_price = prev_close_price;
    self
  }
  ///Цена предыдущего закрытия
  ...
  pub fn with_symbol(mut self, symbol: String) -> SymbolFutures {
    self.symbol = symbol;
    self
  }
  ///Тикер (Код финансового инструмента)
  ...
  pub fn with_rtype(mut self, rtype: String) -> SymbolFutures {
    self.rtype = rtype;
    self
  }
  ...
  pub fn with_volume(mut self, volume: Decimal) -> SymbolFutures {
    self.volume = volume;
    self
  }
  ///Объём
  ...
  pub fn with_ryield(mut self, ryield: i32) -> SymbolFutures {
    self.ryield = Some(ryield);
    self
  }
