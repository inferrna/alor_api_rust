...
impl BodyrequestOrdersActionsStoplimit {
  pub fn new(instrument: BodyrequestOrdersActionsLimitInstrument, order_end_unix_time: i64, price: Decimal, quantity: i32, side: Side, trigger_price: Decimal, user: BodyrequestOrdersActionsLimitUser, iceberg_fixed: i32, iceberg_variance: Decimal, time_in_force: LifePolicy, ) -> BodyrequestOrdersActionsStoplimit {
