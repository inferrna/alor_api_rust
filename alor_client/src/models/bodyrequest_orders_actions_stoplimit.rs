...
impl BodyrequestOrdersActionsStoplimit {
  pub fn new(instrument: BodyrequestOrdersActionsLimitInstrument, order_end_unix_time: i64, price: i32, quantity: i32, side: Operation, trigger_price: i32, user: BodyrequestOrdersActionsLimitUser, iceberg_fixed: Decimal, iceberg_variance: Decimal, time_in_force: LifePolicy, ) -> BodyrequestOrdersActionsStoplimit {
  ...
  pub fn with_price(mut self, price: i32) -> BodyrequestOrdersActionsStoplimit {
    self.price = price;
    self
  }
  ...
  pub fn with_side(mut self, side: Operation) -> BodyrequestOrdersActionsStoplimit {
    self.side = side;
    self
  }
  ...
  pub fn set_trigger_price(&mut self, trigger_price: i32) {
    self.trigger_price = trigger_price;
  }

  pub fn with_trigger_price(mut self, trigger_price: i32) -> BodyrequestOrdersActionsStoplimit {
    self.trigger_price = trigger_price;
    self
  }
  ...
  pub fn with_iceberg_fixed(mut self, iceberg_fixed: Decimal) -> BodyrequestOrdersActionsStoplimit {
    self.iceberg_fixed = iceberg_fixed;
    self
  }
