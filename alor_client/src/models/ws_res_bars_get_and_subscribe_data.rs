...
/// WsResBarsGetAndSubscribeData : Сообщение с данными о ценах на рынке (свечи)
...
impl WsResBarsGetAndSubscribeData {
  pub fn new(close: Decimal, high: Decimal, low: Decimal, open: Decimal, time: i64, volume: i64, ) -> WsResBarsGetAndSubscribeData {
  ...
  pub fn with_close(mut self, close: Decimal) -> WsResBarsGetAndSubscribeData {
    self.close = close;
    self
  }
  ///Цена при закрытии
  ...
  pub fn with_high(mut self, high: Decimal) -> WsResBarsGetAndSubscribeData {
    self.high = high;
    self
  }
  ///Максимальная цена
  ...
  pub fn with_low(mut self, low: Decimal) -> WsResBarsGetAndSubscribeData {
    self.low = low;
    self
  }
  ///Минимальная цена
  ...
  pub fn with_open(mut self, open: Decimal) -> WsResBarsGetAndSubscribeData {
    self.open = open;
    self
  }
  ///Цена при открытии
  ...
  pub fn with_volume(mut self, volume: i64) -> WsResBarsGetAndSubscribeData {
    self.volume = volume;
    self
  }
  ///Объём
