...
pub struct BodyrequestOrdersActionsLimitUser {
...
impl BodyrequestOrdersActionsLimitUser {
  pub fn new(account: String, portfolio: String, ) -> BodyrequestOrdersActionsLimitUser {
    BodyrequestOrdersActionsLimitUser {
      account: account,
      portfolio: portfolio
    }
  }
  ...
  pub fn with_account(mut self, account: String) -> BodyrequestOrdersActionsLimitUser {
    self.account = account;
    self
  }
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> BodyrequestOrdersActionsLimitUser {
    self.portfolio = portfolio;
    self
  }
