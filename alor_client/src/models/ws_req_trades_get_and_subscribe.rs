...
pub struct WsReqTradesGetAndSubscribe {
...
impl WsReqTradesGetAndSubscribe {
  pub fn new(exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, portfolio: String, token: String, ) -> WsReqTradesGetAndSubscribe {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqTradesGetAndSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqTradesGetAndSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqTradesGetAndSubscribe {
    self.guid = guid;
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> WsReqTradesGetAndSubscribe {
    self.token = token;
    self
  }
