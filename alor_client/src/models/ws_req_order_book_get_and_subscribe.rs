...
impl WsReqOrderBookGetAndSubscribe {
  pub fn new(exchange: Exchange, format: Format, frequency: i32, guid: String, token: String, ) -> WsReqOrderBookGetAndSubscribe {
  ...
  pub fn with_format(mut self, format: Format) -> WsReqOrderBookGetAndSubscribe {
    self.format = format;
    self
  }
