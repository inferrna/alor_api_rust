...
impl WsReqOrderBookGetAndSubscribe {
  pub fn new(code: String, depth: i32, exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, token: String, ) -> WsReqOrderBookGetAndSubscribe {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqOrderBookGetAndSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqOrderBookGetAndSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqOrderBookGetAndSubscribe {
    self.guid = guid;
    self
  }
  ///Уникальный идентификатор сообщений создаваемой подписки. Все входящие сообщения, соответствующие этой подписке, будут иметь такое значение поля guid.
  ...
  pub fn with_token(mut self, token: String) -> WsReqOrderBookGetAndSubscribe {
    self.token = token;
    self
  }
  ///JWT токен для авторизации
