...
impl RiskRate {
  pub fn new(asset_type: String, created_at: String, currency_code: String, exchange: Exchange, id: Decimal, instrument: String, is_direct: bool, is_marginal: bool, is_short_sell_possible: bool, isin: String, rate_down: Decimal, rate_symmetric: Decimal, rate_up: Decimal, risk_category_id: Decimal, set_rate: Decimal, updated_at: String, ) -> RiskRate {
    RiskRate {
  ...
  pub fn with_id(mut self, id: Decimal) -> RiskRate {
    self.id = id;
    self
  }
  ///Id записи
  ...
  pub fn set_risk_category_id(&mut self, risk_category_id: Decimal) {
    self.risk_category_id = risk_category_id;
  }

  pub fn with_risk_category_id(mut self, risk_category_id: Decimal) -> RiskRate {
    self.risk_category_id = risk_category_id;
    self
  }
  ///Id категории риска
  ...
  pub fn with_updated_at(mut self, updated_at: String) -> RiskRate {
    self.updated_at = updated_at;
    self
  }
  ///Время последнего обновления ставки риска
