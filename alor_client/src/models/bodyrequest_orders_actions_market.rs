...
impl BodyrequestOrdersActionsMarket {
  pub fn new(instrument: BodyrequestOrdersActionsLimitInstrument, order_end_unix_time: i64, quantity: i32, side: Side, user: BodyrequestOrdersActionsLimitUser, comment: String, ) -> BodyrequestOrdersActionsMarket {
  ...
  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsLimitInstrument) -> BodyrequestOrdersActionsMarket {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_order_end_unix_time(mut self, order_end_unix_time: i64) -> BodyrequestOrdersActionsMarket {
    self.order_end_unix_time = order_end_unix_time;
    self
  }
  ///Время (UTC) завершения сделки в формате Unix Time seconds
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsMarket {
    self.quantity = quantity;
    self
  }
  ///Количество
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsMarket {
    self.side = side;
    self
  }
  ...
  pub fn with_user(mut self, user: BodyrequestOrdersActionsLimitUser) -> BodyrequestOrdersActionsMarket {
    self.user = user;
    self
  }
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsMarket {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
