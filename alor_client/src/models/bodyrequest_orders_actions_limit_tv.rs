...
impl BodyrequestOrdersActionsLimitTv {
  pub fn new(iceberg_fixed: Decimal, iceberg_variance: Decimal, instrument: BodyrequestOrdersActionsLimitTvInstrument, price: Decimal, quantity: i32, side: Operation, time_in_force: LifePolicy, rtype: String, user: BodyrequestOrdersActionsLimitTvUser, ) -> BodyrequestOrdersActionsLimitTv {
  ...
  pub fn with_iceberg_fixed(mut self, iceberg_fixed: Decimal) -> BodyrequestOrdersActionsLimitTv {
    self.iceberg_fixed = iceberg_fixed;
    self
  }
  ///Видимая постоянная часть айсберг-заявки в лотах
  ...
  pub fn with_side(mut self, side: Operation) -> BodyrequestOrdersActionsLimitTv {
    self.side = side;
    self
  }
