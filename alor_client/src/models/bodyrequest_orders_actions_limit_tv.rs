...
impl BodyrequestOrdersActionsLimitTv {
  pub fn new(iceberg_fixed: i32, iceberg_variance: Decimal, instrument: BodyrequestOrdersActionsLimitTvInstrument, price: Decimal, quantity: i32, side: Side, time_in_force: LifePolicy, rtype: String, user: BodyrequestOrdersActionsLimitTvUser, ) -> BodyrequestOrdersActionsLimitTv {
