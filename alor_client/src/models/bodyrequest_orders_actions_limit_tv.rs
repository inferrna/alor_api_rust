...
impl BodyrequestOrdersActionsLimitTv {
  pub fn new(comment: String, iceberg_fixed: i32, iceberg_variance: Decimal, instrument: BodyrequestOrdersActionsLimitTvInstrument, price: Decimal, quantity: i32, side: Side, time_in_force: LifePolicy, rtype: String, user: BodyrequestOrdersActionsLimitTvUser, ) -> BodyrequestOrdersActionsLimitTv {
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsLimitTv {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
  ...
  pub fn with_iceberg_fixed(mut self, iceberg_fixed: i32) -> BodyrequestOrdersActionsLimitTv {
    self.iceberg_fixed = iceberg_fixed;
    self
  }
  ///Видимая постоянная часть айсберг-заявки в лотах
  ...
  pub fn with_iceberg_variance(mut self, iceberg_variance: Decimal) -> BodyrequestOrdersActionsLimitTv {
    self.iceberg_variance = iceberg_variance;
    self
  }
  ///Амплитуда отклонения (в % от icebergFixed) случайной надбавки к видимой части айсберг-заявки. Только срочный рынок
  ...
  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsLimitTvInstrument) -> BodyrequestOrdersActionsLimitTv {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_price(mut self, price: Decimal) -> BodyrequestOrdersActionsLimitTv {
    self.price = price;
    self
  }
  ///Цена
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsLimitTv {
    self.quantity = quantity;
    self
  }
  ///Количество (лоты)
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsLimitTv {
    self.side = side;
    self
  }
  ...
  pub fn with_time_in_force(mut self, time_in_force: LifePolicy) -> BodyrequestOrdersActionsLimitTv {
    self.time_in_force = time_in_force;
    self
  }
  ...
  pub fn with_rtype(mut self, rtype: String) -> BodyrequestOrdersActionsLimitTv {
    self.rtype = rtype;
    self
  }
  ///Тип заявки
  ...
  pub fn with_user(mut self, user: BodyrequestOrdersActionsLimitTvUser) -> BodyrequestOrdersActionsLimitTv {
    self.user = user;
    self
  }
  ...
  pub fn validate(&self) {
    ...
    assert!(self.iceberg_variance<=max_value, "BodyrequestOrdersActionsLimitTv.iceberg_variance should be <= 20");
  }
