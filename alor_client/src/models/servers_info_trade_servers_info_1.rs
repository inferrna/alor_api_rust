...
impl ServersInfoTradeServersInfo1 {
  pub fn new(contracts: String, trade_server_code: String, ) -> ServersInfoTradeServersInfo1 {
  ...
  pub fn with_account_num(mut self, account_num: String) -> ServersInfoTradeServersInfo1 {
    self.account_num = Some(account_num);
    self
  }
  ...
  pub fn with_addresses(mut self, addresses: String) -> ServersInfoTradeServersInfo1 {
    self.addresses = Some(addresses);
    self
  }
  ...
  pub fn with_contracts(mut self, contracts: String) -> ServersInfoTradeServersInfo1 {
    self.contracts = contracts;
    self
  }
  ...
  pub fn with_market(mut self, market: String) -> ServersInfoTradeServersInfo1 {
    self.market = Some(market);
    self
  }
  ...
  pub fn with_trade_server_code(mut self, trade_server_code: String) -> ServersInfoTradeServersInfo1 {
    self.trade_server_code = trade_server_code;
    self
  }
  ...
  pub fn with_rtype(mut self, rtype: String) -> ServersInfoTradeServersInfo1 {
    self.rtype = Some(rtype);
    self
  }
