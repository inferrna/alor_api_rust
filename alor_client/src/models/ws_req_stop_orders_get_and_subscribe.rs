...
pub struct WsReqStopOrdersGetAndSubscribe {
...
impl WsReqStopOrdersGetAndSubscribe {
  pub fn new(exchange: Exchange, format: JsonFormat, guid: String, opcode: OpcodeEnum, portfolio: String, token: String, ) -> WsReqStopOrdersGetAndSubscribe {
  ...
  pub fn with_exchange(mut self, exchange: Exchange) -> WsReqStopOrdersGetAndSubscribe {
    self.exchange = exchange;
    self
  }
  ...
  pub fn with_format(mut self, format: JsonFormat) -> WsReqStopOrdersGetAndSubscribe {
    self.format = format;
    self
  }
  ...
  pub fn with_guid(mut self, guid: String) -> WsReqStopOrdersGetAndSubscribe {
    self.guid = guid;
    self
  }
  ...
  pub fn with_opcode(mut self, opcode: OpcodeEnum) -> WsReqStopOrdersGetAndSubscribe {
    self.opcode = opcode;
    self
  }
  ...
  pub fn with_portfolio(mut self, portfolio: String) -> WsReqStopOrdersGetAndSubscribe {
    self.portfolio = portfolio;
    self
  }
  ...
  pub fn with_token(mut self, token: String) -> WsReqStopOrdersGetAndSubscribe {
    self.token = token;
    self
  }
