...
pub struct BodyrequestOrdersActionsLimit {
...
impl BodyrequestOrdersActionsLimit {
  pub fn new(instrument: BodyrequestOrdersActionsLimitInstrument, order_end_unix_time: i64, price: Decimal, quantity: i32, side: Side, user: BodyrequestOrdersActionsLimitUser, comment: String, ) -> BodyrequestOrdersActionsLimit {
  ...
  pub fn with_instrument(mut self, instrument: BodyrequestOrdersActionsLimitInstrument) -> BodyrequestOrdersActionsLimit {
    self.instrument = instrument;
    self
  }
  ...
  pub fn with_price(mut self, price: Decimal) -> BodyrequestOrdersActionsLimit {
    self.price = price;
    self
  }
  ///Цена
  ...
  pub fn with_quantity(mut self, quantity: i32) -> BodyrequestOrdersActionsLimit {
    self.quantity = quantity;
    self
  }
  ///Количество
  ...
  pub fn with_side(mut self, side: Side) -> BodyrequestOrdersActionsLimit {
    self.side = side;
    self
  }
  ...
  pub fn with_user(mut self, user: BodyrequestOrdersActionsLimitUser) -> BodyrequestOrdersActionsLimit {
    self.user = user;
    self
  }
  ...
  pub fn with_comment(mut self, comment: String) -> BodyrequestOrdersActionsLimit {
    self.comment = comment;
    self
  }
  ///Пользовательский комментарий к заявке
