...
impl BodyrequestOrdersActionsLimit {
  pub fn new(instrument: BodyrequestOrdersActionsLimitInstrument, order_end_unix_time: i64, price: Decimal, quantity: i32, side: Side, user: BodyrequestOrdersActionsLimitUser, ) -> BodyrequestOrdersActionsLimit {
